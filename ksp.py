...
class ScaledVersion(object):
    """docstring for ScaledVersion"""
    def __init__(self, **kwargs):
        for k, v in kwargs.items():
            setattr(self, k, v)
...
scaledversion = ScaledVersion(type='Vacuum', fadeStart=135000, fadeEnd=140000,
                              sphericalModel=False, deferMesh=False, 
                              invisible=False)
...
scaledversion = ScaledVersion(type='Vacuum', fadeStart=8000, fadeEnd=39000,
                              sphericalModel=False, deferMesh=False,
                              invisible=False)
		...
		Properties
		{
			...
			Biomes
			{
				Value
				{
					...
					value = 0
					color = 0.474509805,0.466666669,0.4627451,1
				}
				Value
				{
					name = Midlands
				...
				Value
				{
					...
					displayName = Eastern Mountain Ridge
					value = 0
					color = 1,1,1,1
				}
				Value
				{
					...
					displayName = Western Mountain Ridge
					value = 0
					color = 0.925490201,0.925490201,0.925490201,1
				}
				Value
				{
					name = Lowlands
				...
				Value
				{
					...
					displayName = South Eastern Mountain Range
					value = 0
					color = 0.854901969,0.854901969,0.854901969,1
				}
				Value
				{
					name = South Pole
				...
				Value
				{
					...
					displayName = Central Mountain Range
					value = 0
